...
- [Accounts and IAM Basics](#-accounts---identity-and-access-management-iam-basics)
  ...
  - [IAM Access Keys](#iam-access-keys)
    - [Access Keys consist of two parts](#access-keys-consist-of-two-parts)

- [Cloud Computing Fundamentals](#%EF%B8%8Fcloud-computing-fundamentals)
...
- [AWS Fundamentals](#-aws-fundamentals)
  ...
  - [Virtual Private Cloud (VPC) Basics](#virtual-private-cloud-vpc-basics)
    - [Default VPC Basic](#default-vpc-basic)
  - [Elastic Compute Cloud (EC2) Basics](#elastic-compute-cloud-ec2-basics)
    - [EC2 Key Facts & Features](#ec2-key-facts--features)
  ...
  - [Simple Storage Service (S3) Basics](#simple-storage-service-s3-basics)
    ...
    - [Summary](#summary)
    - [S3 Patterns and Anti-Patterns](#s3-patterns-and-anti-patterns)
...
- [IAM, Account, and AWS Organizations](#-iam-account-and-aws-organizations)
  - [IAM Identity Policies](#iam-identity-policies)
    - [IAM Policy Document](#iam-policy-document)
  ...
  - [CloudTrail Essentials](#cloudtrail-essentials)
    - [CloudTrail Basic](#cloudtrail-basic)
